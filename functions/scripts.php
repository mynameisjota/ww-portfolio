...
function add_theme_scripts() {
    ...
    wp_enqueue_style( 'animate', get_template_directory_uri() . '/scss/animate.css', array(), '1.1', 'all');
    ...
    wp_enqueue_script('uow', get_template_directory_uri(). '/js/wow.min.js', array(''), '1.0', true);
  }
