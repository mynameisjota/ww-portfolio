...
if ($_POST['leaveblank'] != '' or $_POST['dontchange'] != 'http://') {
  ...
  echo "<h2
	...
	font-weight: normal;
	color: #1b1b1b;
	\"><center><span>Aconteceu algum erro!</span><p>Você pode tentar denovo ou enviar direto para " . $email_envio . "contato@wwcomunicacao.com.br</p></center><h2>";
...
if(!$mail->send()) {
  ...
  echo "<h2
	...
	font-weight: normal;
	color: #89bb50;
	\"><center><span>Formulário Enviado</span><p>Muito obrigado, em breve entraremos em contato.</p></center><h2>";
